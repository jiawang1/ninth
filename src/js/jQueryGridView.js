define(['jquery','backbone', 'underscore','text!../template/jQueryGridTpl.html','jqGrid'],function($,Backbone,_,sJQueryGridTemplate){
    "use strict";
    
        var JQueryGridView = Backbone.View.extend({
        ...
        render:function(){
             this.$el.html(_.template(sJQueryGridTemplate));
        ...
        $grid.jqGrid({
          ...
          var  initDateSearch = function (elem) {
           ...
           var editableInAddForm = function (options) {
